...
//  },
    ...
    __format_lat: function(lat) {
        ...
        if (lat < 0) {
            return '' + parseInt(lat*-10)/10 + 'S';
        }
        else if (lat > 0) {
            return '' + parseInt(lat*10)/10 + 'N';
        }
        return '' + lat;
    },
    ...
    __format_lng: function(lng) {
        ...
        // todo: format type of float
        if (lng > 180) {
            return '' + parseInt(3600 - lng*10)/10 + 'W';
        }
        else if (lng > 0 && lng < 180) {
            return '' + parseInt(10*lng)/10 + 'E';
        }
        else if (lng < 0 && lng > -180) {
            return '' + parseInt(lng*-10)/10 + 'W';
        }
        else if (lng == -180) {
            return '' + parseInt(lng*-10)/10;
        }
        else if (lng < -180) {
            return '' + parseInt(3600 + lng*10)/10 + 'W';
        }
